...
export default class EditTeacher extends Component {
        ...
        axios.get('http://localhost:5000/Teacher/' + this.props.match.params.id)
            .then(response => {
                this.setState({
                    ...
                    Teaching_Module: response.data.Teaching_Module,
        ...
        axios.get('http://localhost:5000/Teacher/')
            .then(response => {
                if (response.data.length > 0) {
                    this.setState({
                        Teacher: response.data.map(Teacher => Teacher.TID),
                    })
                }
            })
            .catch((error) => {
    ...
    onSubmit(e) {
        ...
        const {TID,Contact_No} = this.state;
            ...
            if (TID.length < 4) {
                ...
                swal("Contact_No No invalid !", "Contact No No should be greater than 9", "error");
            }else{

            axios
                .post('http://localhost:5000/Teacher/update/' + this.props.match.params.id, Teacher)
    ...
    render() {
        return (<div  >
            ...
            <font face = "Comic sans MS" size = "6" > Update Teacher </font>
            </h3 > <br></br>
