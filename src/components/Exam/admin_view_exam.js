      ...
      <div className='container'>
         <div style={{ 
          ...
          <div className='text-end  mt-5'>
              <h5>Duration : <span>{duration} Minutes</span> </h5>
          </div>
          <div className='row  mt-3'>
            ...
            {questions.map((question, index) => (
              <div key={index}>
                ...
                <ul style={{listStyle: "none"}}>
                  <li>
                    <input disabled type="radio" name={`question${index}`} value={question.optionOne} checked={selectedAnswers[index] === question.optionOne} onChange={() => handleAnswerSelection(index, question.optionOne , 1)} />
                    &nbsp;{question.optionOne}
                  </li>
                  <li>
                    <input disabled type="radio" name={`question${index}`} value={question.optionTwo} checked={selectedAnswers[index] === question.optionTwo} onChange={() => handleAnswerSelection(index, question.optionTwo , 2)} />
                    &nbsp;{question.optionTwo}
                  </li>
                  <li>
                    <input disabled type="radio" name={`question${index}`} value={question.optionThree} checked={selectedAnswers[index] === question.optionThree} onChange={() => handleAnswerSelection(index, question.optionThree , 3)} />
                    &nbsp;{question.optionThree}
                  </li>
                  <li>
                    <input disabled type="radio" name={`question${index}`} value={question.optionFour} checked={selectedAnswers[index] === question.optionFour} onChange={() => handleAnswerSelection(index, question.optionFour , 4)} />
                    &nbsp;{question.optionFour}
                  </li>
                </ul>
                <br/>
            ...
            <button className='btn btn-success shadow-0' onClick={back_action}>Back</button>
            </div>
            {showResult && (
              <div>
